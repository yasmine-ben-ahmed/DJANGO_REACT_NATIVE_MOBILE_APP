...
from myApp.models import supervisor
    ...
    if request.method == 'POST':
        ...
        if formulairep.is_valid():
            ...
            if selected_client_id:
                ...
                instance.save()                
                return redirect('add_client',pseudo=pseudo,id=instance.polygon_id)
...
def add_client(request,id,pseudo):
        superviseur = supervisor.objects.get(pseudo=pseudo)
        projects = myProject.objects.filter(supervisorp=superviseur).order_by('-polygon_id')
        ...
        if request.method == 'POST':
            ...
            if formulaire.is_valid():
                ...
                formulaire.enregistrer(id,pseudo)
